    ...
    <div className="grid w-full gap-4">
      <Card className="relative overflow-hidden border-0 bg-[radial-gradient(circle_at_82%_18%,rgba(199,154,55,.25),transparent_28%),linear-gradient(115deg,#fffdf9_0%,#f7f0e3_100%)] shadow-none dark:bg-card">
        <CardContent className="relative min-h-80 p-7 sm:p-9">
          ...
          <div className="pointer-events-none absolute right-0 bottom-0 hidden h-full w-[38%] overflow-hidden lg:block"><div className="absolute inset-0 bg-[linear-gradient(90deg,transparent,rgba(104,77,31,.09))]" /><div className="absolute right-10 bottom-9 grid size-40 place-items-center rounded-full border border-[#b68829]/30 bg-[#fffdf9]/75 shadow-2xl backdrop-blur"><Crown className="size-16 text-[#9a711f]" /><span className="absolute -bottom-7 text-center text-[10px] font-bold tracking-[.2em] text-[#765718]">DIREITO TRANSFORMA<br />REALIDADES</span></div><div className="absolute right-0 bottom-0 h-20 w-72 bg-[linear-gradient(135deg,#5f4630,#1d1813)] shadow-2xl" /></div>
        </CardContent>
      </Card>

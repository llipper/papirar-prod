...
function contentSecurityPolicy(nonce: string): string {
  ...
  return [
    ...
    "img-src 'self' data: blob: https://*.googleusercontent.com https://*.r2.dev https://*.r2.cloudflarestorage.com https://*.mlstatic.com https://www.mercadolibre.com https://www.mercadolivre.com",
    "worker-src 'self' blob:",
    "font-src 'self' data:",
    "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com https://*.workers.dev https://api.mercadopago.com https://*.mercadopago.com https://*.mercadolibre.com https://*.mlstatic.com",
